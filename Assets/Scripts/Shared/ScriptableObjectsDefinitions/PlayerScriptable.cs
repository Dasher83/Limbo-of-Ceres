...
{
    [CreateAssetMenu(fileName = "PlayerData", menuName = "ScriptableObjects/PlayerScriptable", order = 2)]
    public class PlayerScriptable : ScriptableObject, IDurable, IDamageable, IRestorable, IInitializable
    {
